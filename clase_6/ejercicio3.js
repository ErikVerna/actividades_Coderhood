...
function buscarItem (item){
    ...
    return item.inventario.includes("Katana de fuego")
}


const jugadoresTrampa = jugadores.filter(buscarItem).map(buscarID)
